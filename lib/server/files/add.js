...
exports.default = function (getIpfs, opts) {
  return {
    add: (0, _postmsgRpc.expose)('ipfs.add', (0, _prepost.pre)(function () {
      ...
      return (_getIpfs = getIpfs()).add.apply(_getIpfs, arguments);
    }), opts),
    addPullStream: (0, _postmsgRpc.expose)('ipfs.files.addPullStream', (0, _prepost.pre)(opts.pre('files.addPullStream'), function () {
      ...
      }), (_getIpfs$files = getIpfs().files).addPullStream.apply(_getIpfs$files, _toConsumableArray(args.slice(1))), _pullPostmsgStream2.default.sink(readFnName, opts));
