...
exports.default = function (getIpfs, opts) {
  return {
    cat: (0, _postmsgRpc.expose)('ipfs.cat', (0, _prepost.pre)((0, _buffer.preBufferFromJson)(0), (0, _cid.preCidFromJson)(0), opts.pre('cat'), (0, _prepost.post)(function () {
      var _getIpfs;

      return (_getIpfs = getIpfs()).cat.apply(_getIpfs, arguments);
    }, _buffer.bufferToJson)), opts),
    catPullStream: (0, _postmsgRpc.expose)('ipfs.catPullStream', (0, _prepost.pre)((0, _buffer.preBufferFromJson)(0), (0, _cid.preCidFromJson)(0), opts.pre('catPullStream'), (0, _prepost.post)(function () {
      var _getIpfs2;

      return (_getIpfs2 = getIpfs()).catPullStream.apply(_getIpfs2, arguments);
    }, function (res) {
